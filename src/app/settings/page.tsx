  ...
  return (
    <AppLayout searchPlaceholder="Search settings...">
      <div className="flex justify-between items-center mb-6 select-none animate-fade-in">
        <div>
          ...
          <p className="text-xs font-semibold text-text-light mt-1">
            Configure integrations, deploy environments, and workspace attributes.
          </p>
        </div>
        ...
        <Button
          size="sm"
          variant="primary"
          icon={<Save size={14} className="stroke-[3]" />}
      ...
      <div className="bg-white border border-border-warm rounded-2xl p-16 flex flex-col items-center justify-center text-center shadow-xs select-none animate-scale-in">
        ...
        <p className="text-sm font-extrabold text-text-dark">Global Account Settings</p>
        <p className="text-xs text-text-light font-medium mt-1.5 max-w-sm">
          Here you will be able to customize notifications, configure Slack & Email webhook alerts, and manage API keys for deployments.
        </p>
      </div>
    </AppLayout>
  );
